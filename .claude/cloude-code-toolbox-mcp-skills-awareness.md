...
_Generated: 2026-05-18T04:49:53.729Z_
...
Workspace `mcp.json` _(folder: CafeteriaProyecto)_

- **c:\Users\pardo\OneDrive\Desktop\Electivas\Modelos de computacion\CafeteriaProyecto\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\pardo\.claude.json** — _File exists — no servers defined_
...
- **skill-creator** — `C:\Users\pardo\.claude\skills\skill-creator`
